...
<body id="page-top">
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to UMKM - Digital</h1>
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">UMKM - Digital</h4>
                <p class="isi-fitur text-center">UMKM - Selamat datang di Sistem Aplikasi Keuangan UMKM Digital, solusi inovatif untuk membantu Usaha Mikro, Kecil, dan Menengah (UMKM) dalam mengelola keuangan mereka dengan lebih mudah dan efisien. Kami memahami tantangan yang dihadapi oleh UMKM dalam mengatur pembukuan, pelacakan transaksi, dan analisis keuangan. Oleh karena itu, kami menghadirkan aplikasi yang dirancang khusus untuk memenuhi kebutuhan Anda. </p>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="row text-center">
                        <div class="col col1">
                            <a href="https://www.facebook.com/profile.php?id=100094007205590&mibextid=kFxxJD" target="_blank">
                        ...
                        <div class="col col3">
                            <a href="https://www.instagram.com/adam_zaf99?igsh=dXJqajM0b2N3a2tl" target="_blank">
                    ...
                    <div class="row row3 text-center">
                        ...
                        <div class="col-4">
                            <a href="https://chat.whatsapp.com/JAzPjo5v5nJEHSa21qsZjx" target="_blank">
                                <!-- <img src="icons/whatsapp.png" width="38%"> -->
                                <img src="https://img.icons8.com/color/480/000000/whatsapp.png" width="38%">
                            </a>
                        </div>
                        <div class="col-4 text-left">
                            <a href="https://youtube.com/@admzzz111?si=J2N101wgxI7-Peu5" target="_blank">
