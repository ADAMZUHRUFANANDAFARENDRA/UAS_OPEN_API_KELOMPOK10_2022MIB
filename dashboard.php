...
<head>
    ...
    <title>UMKM-Digital - Dashboard</title>
...
<body>
    <div class="header">
        <img src="img/images.jpeg" width="30px" height="30x" class="float-left logo-fav">
        <h3 class="text-secondary font-weight-bold float-left logo">UMKM-Digital</h3>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                <li class="rentang">
                    <img src="img/GAMBAR ADAM FORMAL.jpg" class="img-fluid profile float-left" width="60px">
                    <h5 class="admin"><?= substr($ambilNama, 0, 7) ?></h5>
                    <div class="online online2">
                        <p class="float-right ontext">Aktif</p>
